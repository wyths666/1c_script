...
async def radio():
    ...
    file = Path('C:/MyProjects/1c_scripts/остатки') / 'радио.xlsx'
    ...
    output_file = output_dir / f'Склад Радио от {current_date}.xlsx'
    if not result.empty:
    ...
    # Сохраняем файл
    filename = output_dir / f'Магазины Радио от {current_date}.xlsx'
    wb.save(filename)
