...
result = df[(df['Остаток_в_магазине'] == 0) & (df['Остаток_на_складе'] > 0)]

# Сохраняем результат
result[['Номенклатура', 'Остаток_в_магазине', 'Остаток_на_складе']].to_excel('есть_на_складе_нет_в_магазине.xlsx', index=False)
